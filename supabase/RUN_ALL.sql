-- ═══════════════════════════════════════════════════════════════════════
-- FORNO — COMPLETE DATABASE SETUP, ONE FILE
--
-- HOW TO RUN
...
--
-- Builds everything: tables, indexes, row-level security, the image
-- storage bucket, and all 15 categories with 67 dishes.
-- Safe to run more than once.
--
-- (This is 01_schema.sql + 02_storage.sql + 03_seed.sql concatenated.
--  Run those individually instead if you prefer smaller steps.)
-- ═══════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════ VERIFY ═══════════════════════════
-- Should report 15 categories and 67 dishes.
select
